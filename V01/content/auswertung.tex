...
\end{figure} 
Als nächstes wird die Kalibration durchgeführt. Als Messzeit wurden erneut $\SI{10}{\second}$ gewählt. Die Fitgerade, für die Umrechnung der Kanalnummern in Messzeiten, kann durch 
\begin{equation}
    \label{eqn:kali}
    t(C) = AC + B
\end{equation}
